...
class Housing extends Model implements HasMedia
{
    ...
    /**
     * Check if the user can perform an action on this housing.
     */
    ...
    /**
     * Check if the user can view this housing.
     */
    ...
    /**
     * Check if theuser can update this housing.
     */
    ...
    /**
     * Check if the user can delete this housing.
     */
    ...
    /**
     * Check if the user can create housings for the associated travel.
     */
    public function canCreateForTravel(User $user): bool
    {
        return $this->travel->can($user, 'createHousing');
    }
}
