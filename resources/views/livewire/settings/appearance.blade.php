<section class="w-full" role="main" aria-labelledby="appearance-heading">
    ...
    <x-settings.layout :heading="__('Appearance')" :subheading=" __('Update the appearance settings for your account')">
        <flux:radio.group x-data variant="segmented" x-model="$flux.appearance" role="radiogroup" aria-labelledby="appearance-heading" aria-label="Sélection du thème d'apparence">
